...
export class NutritionController {
  ...
  findAll(
    ...
    return this.nutritionService.findAll(req.user.id, startDate, endDate, mealType, limit);
  }
  ...
  update(
    ...
    return this.nutritionService.update(id, req.user.id, updateNutritionMetricDto);
  }
